...
---
= Keystone Collector 비공개 모드 설치 요구 사항
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* 매달 Keystone Collector에서 파일을 내보내 NetApp 지원팀에 이메일로 보내주십시오. 지원팀에 연락하는 방법에 대한 자세한 내용은 link:../concepts/support-services.html["Keystone 지원 서비스"]을 참조하십시오.

...
자세한 내용은 https://docs.netapp.com/us-en/keystone-staas/integrations/monitoring-alert-monitors.html["Keystone 구독에 대한 알림 모니터 보기 및 생성"]을 참조하십시오.
...
이제 구독 타임라인 차트에서 여러 유형의 구독 업데이트가 같은 날에 발생할 경우, 개별 아이콘 대신 숫자가 표시됩니다. 숫자 위에 마우스를 올리면 해당 날짜의 모든 업데이트 유형을 확인할 수 있습니다. 다운로드한 보고서에는 각 업데이트에 대한 별도의 행이 포함되어 모든 변경 사항을 완벽하게 기록합니다. 자세한 내용은 https://docs.netapp.com/us-en/keystone-staas/integrations/subscription-timeline.html["Keystone 구독의 타임라인을 확인하세요"]을 참조하십시오.
...
*소비 추세* 탭의 기간별 데이터 차트에서 이제 버스트 제한을 초과하는 사용량이 강조 표시됩니다. 자세한 내용은 https://docs.netapp.com/us-en/keystone-staas/integrations/consumption-tab.html["Keystone 구독의 소비 추세를 확인하세요"]을 참조하십시오.
...
*소비 추세* 탭의 *기간별 소비량* 보기에서 *예측* 토글을 사용하여 현재 날짜로부터 향후 120일 동안의 용량 사용량을 예측할 수 있습니다. 자세한 내용은 https://docs.netapp.com/us-en/keystone-staas/integrations/consumption-tab.html#view-forecast-data["예측 데이터 보기"]을 참조하십시오.
...
Data Infrastructure Insights(DII) 추가 기능 사용량이 이제 *현재 사용량* 및 *사용량 추세* 탭에 표시됩니다. 자세한 내용은 https://docs.netapp.com/us-en/keystone-staas/concepts/data-infra-insights.html#view-dii-consumption["DII 소비량 보기"]을 참조하십시오.

...
사용된 용량은 서비스에서 현재 사용되고 있는 TiB 스토리지 용량을 나타냅니다. Keystone 서비스는 특정 서비스 수준에서 모든 볼륨의 논리적 사용된 크기(사용된 물리적 용량 아님)의 합계를 해당 서비스 수준에 대한 사용된 용량으로 간주합니다.



== 버스트 용량

이 용량은 커밋된 용량을 초과한 사용된 용량입니다. 다음 사항을 참고하십시오.

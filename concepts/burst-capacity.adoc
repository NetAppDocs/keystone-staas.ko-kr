...
버스트 용량은 구독 시 약정된 용량을 초과하여 사용할 수 있는 추가 스토리지 용량을 의미합니다. 이는 성능 서비스 수준별로 측정 및 청구됩니다. 기본적으로 버스트 한도는 약정 용량의 20%로 설정되어 있습니다. 하지만 통합 및 블록 최적화 데이터 스토리지 유형에 한해 이 한도를 40% 또는 60%까지 늘릴 수 있습니다.

버스트 한도를 40% 또는 60%로 변경하려면 NetApp Keystone 지원팀에 문의하세요.

버스트 용량 요금 청구 방식에 대한 자세한 내용은 link:../concepts/pricing.html["Keystone 청구 방식에 대해 알아보세요."]을(를) 참조하십시오.

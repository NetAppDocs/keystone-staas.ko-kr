...
* 고객이 새 DII 인스턴스를 시작하는 경우 link:https://docs.netapp.com/us-en/data-infrastructure-insights/concept_subscribing_to_cloud_insights.html#trial-edition["DII 무료 평가판"^]를 사용하는 것이 좋습니다. 이 기능과 필요한 시작 체크리스트에 대한 자세한 내용은 link:https://docs.netapp.com/us-en/data-infrastructure-insights/concept_feature_tutorials.html["피처 튜터리얼"^]을 참조하십시오.
